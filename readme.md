<h1 align="center">odelyzid — Head of the Tribe</h1>

<p align="center">
  <i>Coffee-fueled. Narkotik-infused. Retro at heart.<br>
  Building the #1 Match-2 / Match-3 & Web3 Gaming Platform in 2026 ☕🎮🔗</i>
</p>
...
- **.AI3** (predecessor to TribeWarez)  
  Tensor-optimized low-cost web3 ecosystem & blockchain experiments

- **HellOs**  
  Recreational x86_64 OS written in C + Assembly

- N64 / Retro PC Reverse Engineering & Modding  
- 90s FPS Modding (Doom, Hexen, Quake, Unreal…)  
- Containerized Web & Vue.js experiments
